...
public:
                                   ...
                                   const string    & taxID )
    {
        ...
        if(CompanyUnique(*NewCompany, addr_whereToInsert, taxID_whereToInsert))
        {
            ...
            cout << "taxID :: Inserted " << NewCompany -> _name << " to index: " << taxID_whereToInsert << endl << endl;
            return true;
        }
        else
        {
                                   ...
                                   const string    & addr )
    {
        ...
        else
        {
            ...
            //TODO: NOT SORTED AFTER ERASE - MBY IT IS
            return true;
        }
    }
    ...
    {
        int index = findCompany(name, addr);
        //int invoice_index = binary_search(database.begin(), database.end(),)
        //int invoice_index = binarySearch(0,(int)_invoices.size(),(int)amount);
        if(index == -1)
        {
            return false;
        }
        else
        {
            ...
            //_invoices.at(invoice_index) = amount;
            return true;
        }
    }
...
private:
    ...
    //TODO: Zároveň ukládat databázi sorted podle taxIds
